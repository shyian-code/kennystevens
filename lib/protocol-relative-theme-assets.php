...
if ( ! class_exists( 'kennystevens_Protocol_Relative_Theme_Assets' ) ) :
	class kennystevens_Protocol_Relative_Theme_Assets {
		/**
	...
	$kennystevens_protocol_relative_theme_assets = new kennystevens_Protocol_Relative_Theme_Assets;
endif;
