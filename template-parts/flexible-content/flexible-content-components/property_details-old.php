...
<div class="image-hover-text-cols"<?php echo $offset_style; ?>>
	...
	<?php endif; ?>
	<div class="<?php echo $row_class .$map_parent_class; ?>image-hover-text-cols__row--no-pad image-hover-text-cols__row">
